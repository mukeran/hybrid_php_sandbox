...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/usr/local' '--with-curl' '--with-gd' '--with-mysqli' '--with-openssl' '--with-pdo-mysql' '--with-pdo-sqlite' '--with-pear' '--with-zlib' '--enable-fpm' '--enable-xml' '--enable-zip' '--enable-sockets' '--enable-soap' '--enable-pcntl' '--enable-mbstring'"
